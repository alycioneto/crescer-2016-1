...
$(function () {
    (function () {
        var numeroDeCavaleirosNoArray;
        $.get(urlCavaleiroGet).done(function (e) { numeroDeCavaleirosNoArray = e.data.length });
        setInterval($.get(urlCavaleiroGet)
            .done(function (e) {
                if (e.data.length === numeroDeCavaleirosNoArray)
                    console.log('batata');
            }), 5000)    
        })();
});
